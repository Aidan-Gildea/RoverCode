...
#define RIGHT_DISTANCE_TO_STOP 55 // if in quadrant 1, do 35, else do 60
...
#define TOO_CLOSE_THRESHOLD_L 22
#define TOO_CLOSE_THRESHOLD_R 25
#define TOO_CLOSE_THRESHOLD_FRONT 25
